...
- **Single-Spark SGLang with the PLE n-gram table streamed from NVMe** (open PR [sglang#36567](https://github.com/sgl-project/sglang/pull/36567), applied): full NVFP4 quality on ONE Spark — the 47.7 GiB PLE table stays on the SSD (~78 GiB resident), **~31 t/s single-stream, 43–51 tok/s aggregate at 4–8 concurrent, 262K native ctx**.
...
**SGLang TP1 single-Spark, PLE from NVMe** (262K native ctx, mmap backend, NEXTN):
